...
// general images
  static String forgotPassword = "$imagesPath/forgot.png";
  ...
  static String appLogo = "$imagesPath/tindahan.png";

  static String successful = "$imagesPath/successful.png";

  static String google = "$imagesPath/google.png";
  ...
  // Categories path
  static String mobiles = "$categoriesImagesPath/phones.png";
  static String fashion = "$categoriesImagesPath/clothes.png";
  ...
  static String cosmetics = "$categoriesImagesPath/cosmetic.png";
